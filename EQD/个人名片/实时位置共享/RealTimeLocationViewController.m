...
- (BOOL)quitButtonPressed {
    ...
    UIAlertController  *aelrt = [UIAlertController alertControllerWithTitle:@"是否结束位置共享？" message:nil preferredStyle:UIAlertControllerStyleActionSheet];
    [aelrt addAction:[UIAlertAction actionWithTitle:@"结束" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
