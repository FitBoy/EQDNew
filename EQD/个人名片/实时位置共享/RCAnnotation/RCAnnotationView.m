...
- (id)initWithAnnotation:(id<MKAnnotation>)annotation {
  ...
  if (self) {
    ...
    _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, -35, 40, 40)];
      [_imageView setImageWithURL:[NSURL URLWithString:self.imageUrl] placeholderImage:[RCKitUtility imageNamed:@"default_portrait_msg"
  ...
  if ([keyPath isEqualToString:@"imageUrl"]) {
    dispatch_async(dispatch_get_main_queue(), ^{
      if (![[change objectForKey:@"new"] isKindOfClass:[NSNull class]]) {
          [_imageView setImageWithURL:[NSURL
                                      URLWithString:[change objectForKey:@"new"]] placeholderImage:[RCKitUtility imageNamed:@"default_portrait_msg"
                                                                                                                   ofBundle:@"RongCloud.bundle"]];
