...
- (instancetype)initWithFrame:(CGRect)frame
  ...
  if (self) {
    ...
    [quitButton setImage:[[UIImage imageNamed:@"quit_location_share"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]
    ...
    UIButton *backButton = [[UIButton alloc]
        initWithFrame:CGRectMake(self.bounds.size.width - 8 - 26, 41.5, 26,
                                 26)];
    [backButton setImage:[[UIImage imageNamed:@"back_to_conversation"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]
                forState:UIControlStateNormal];
...
- (void)addHeadViewUser:(RCUserInfo *)user {
  {
    ...
    UIImageView *userHead = [[UIImageView alloc] init];
      [userHead setImageWithURL:[NSURL URLWithString:user.portraitUri] placeholderImage:[RCKitUtility imageNamed:@"default_portrait_msg"
