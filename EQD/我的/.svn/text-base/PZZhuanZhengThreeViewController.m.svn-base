//
//  PZZhuanZhengThreeViewController.m
//  EQD
//
...
#import "PZZhuanZhengThreeViewController.h"
#import "FBTextVViewController.h"
#import "FBTextFieldViewController.h"
#import "FBButton.h"
@interface PZZhuanZhengThreeViewController ()<UITableViewDelegate,UITableViewDataSource,FBTextFieldViewControllerDelegate>
{
    UITableView *tableV;
...
@implementation PZZhuanZhengThreeViewController
...
- (void)viewDidLoad {
    ...
    arr_two = [NSMutableArray arrayWithArray:@[@"部门负责人（已同意）",@"试用期工资",@"转正后工资",@"部门负责人对试用期的评价",@"人力资源（已同意）"]];
